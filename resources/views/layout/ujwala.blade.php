    ...
    <div class="container mx-auto p-8 pb-12 flex flex-col items-start gap-6 lg:flex-row">
        <article class="w-full max-w-5xl">
                    ...
                    <div class="splide__track">
                        <ul class="splide__list">
                            <li class="splide__slide">
                                <img src="{{asset('assets/ujwala/Ujjwala_View_1.jpg')}}" alt="Moonstar Ujwala Layout">
                            </li>
                            <li class="splide__slide">
                                <img src="{{asset('assets/ujwala/Ujjwala_View_2.jpg')}}" alt="Moonstar Ujwala Layout">
                            </li>
                            <li class="splide__slide">
                                <img src="{{asset('assets/ujwala/Ujjwala_View_5.jpg')}}" alt="Moonstar Ujwala Layout">
                            </li>
                            <li class="splide__slide">
                                <img src="{{asset('assets/ujwala/Ujjwala_View_3.jpg')}}" alt="Moonstar Ujwala Layout">
                            </li>
                            <li class="splide__slide">
                                <img src="{{asset('assets/ujwala/Ujjwala_View_6.jpg')}}" alt="Moonstar Ujwala Layout">
                            </li>
                            <li class="splide__slide">
                                <img src="{{asset('assets/ujwala/Ujjwala_View_4.jpg')}}" alt="Moonstar Ujwala Layout">
                            </li>
                            <li class="splide__slide">
                                <img src="{{asset('assets/ujwala/Ujjwala_View_7.jpg')}}" alt="Moonstar Ujwala Layout">
                            </li>
                            <li class="splide__slide">
                                <img src="{{asset('assets/ujwala/Ujjwala_View_8.jpg')}}" alt="Moonstar Ujwala Layout">
                            </li>
                            <li class="splide__slide">
                                <img src="{{asset('assets/ujwala/Ujjwala_View_9.jpg')}}" alt="Moonstar Ujwala Layout">
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <section class="w-full mt-6 bg-white rounded-md p-4 pb-6">
                <div class="w-full">
                    <h1 class="text-3xl font-black text-blue-900 capitalize">Ujwala Layout</h1>
                    <address class="mt-2 text-gray-600">Sidlagatta Road, Chinpalli Station</address>
                </div>
                ...
                <div class="w-full mt-6">
                    ...
                    <div class="w-full mt-4 tab-details" id="propertyDetails">
                        <ul style="list-style: disc; padding-left: 2rem;">
                            <li>Spread around 30 Gunt Acres</li>
                    ...
                    <div class="w-full mt-4 tab-details" id="layoutPlan">
                        <img src="{{asset('assets/ujwala/Ujjwala_View_2.jpg')}}" alt="Layout Full view">
                    </div>
                    ...
                    <div class="w-full mt-4 tab-details" id="locationMap">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d3881.3650972193795!2d78.07436899999999!3d13.389705!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zMTPCsDIzJzIyLjkiTiA3OMKwMDQnMjcuNyJF!5e0!3m2!1sen!2sin!4v1720599276431!5m2!1sen!2sin" class="w-full h-[40dvh]" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                    </div>
        ...
        <aside class="w-full max-w-md lg:sticky top-4">
            <div class="w-full bg-blue-900 px-6 py-8 shadow-md">
                ...
                <form action="{{route('enquiry.store')}}" method="POST" class="w-full mt-6">
                    @csrf
                    <input type="hidden" name="property" value="Ujwala Layout">
                    <div>
