...
<!-- alert -->
<div class="w-full flex items-center p-4 mb-4 text-sm text-{{$alertColor}}-800 border border-{{$alertColor}}-300 rounded-lg bg-{{$alertColor}}-50" role="alert" id="alert">
    ...
    <div class="hidden text-green-800 border-green-300 bg-green-100 text-blue-800 border-blue-300 bg-blue-100 text-red-800 border-red-300 bg-red-100"></div>
